...

{
  ...
  programs.starship = {
    enable = true;
    settings = {
      format = ''[░▒▓](#a3aed2)[ [{](bg:#a3aed2 fg:purple)[󰃤](bg:#a3aed2 fg:purple)[}](bg:#a3aed2 fg:purple) ](bg:#a3aed2 fg:#090c0c)[](bg:#769ff0 fg:#a3aed2)$directory[](fg:#769ff0 bg:#394260)$hg_branch$git_branch[ ](fg:#394260)
        $character'';
      hg_branch={
        disabled=false;
